...
```{r eval=FALSE, tidy=FALSE}
rrtools::use_compendium("pkgname") # use a meaningful name :)
```
...
Before we do this, we need to do some once-off setup. Let's check that Git is ready for us:
...
git config --global user.email 'benmarwick@hotmail.com'
...
Source code hosting:
https://github.com/benmarwick/CSSS-2017-On-Ramps-to-Reproducibility
